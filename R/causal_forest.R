...
#' @param treat name of the treatment indicator variable as character vector (treatment indicator must be binary numeric 1 = treatment, 0 = control).
...
causal_forest <- function(n_trees, data, outcome, covariates, treat, minsize, alpha, feature_fraction, honest_split = TRUE, honesty_fraction){
